...
const key = "uVWllQf5sqvPO1oWEooK8Nnwu9A6ZSAuaPW0J0NxFCdHbKmO"
// 商户号
...
function paysign({ ...args }) {
  ...
  sa.push('key=' + key)
  console.log('sign', JSON.stringify(sa, null, 4))
...
exports.main = async (event, context) => {
  ...
  const notify_url = "https://www.teekstore.com/qiafanfan_notify"
